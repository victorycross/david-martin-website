      ...
      <div className="container py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {posts.map((post, index) => <Card key={index} className={`p-6 hover:shadow-medium transition-all duration-medium ${post.featured ? 'border-primary/20 bg-gradient-to-r from-primary/5 to-accent/5' : ''}`}>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-semibold hover:text-primary transition-colors">
                        ...
                        {post.featured && <Badge variant="secondary" className="bg-primary/10 text-primary">
                            Coming Soon
                          </Badge>}
                    </div>
