      ...
      <div className="container py-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gradient">Applications</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Software solutions designed to solve real-world problems in crisis management, 
              system monitoring, and AI governance.
            </p>
          </div>
